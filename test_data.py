...
data = {
    'entry_id': [1, 2, 3, 4, 5, 6],
    'date': ['2026-09-01', '2026-09-01', '2026-09-02', '2026-09-02', '2026-09-03', '2026-09-03'],
    'account_id': ['1010', '2010', '1010', '1010', '1010', '5010'],
    'debit': [1500.0, 0.0, 500.0, 500.0, 0.0, 85000.0],
    'credit': [0.0, 1500.0, 0.0, 0.0, 3000.0, 0.0]
}

df = pd.DataFrame(data)

if __name__ == '__main__':
    # تشغيل الفحص الشامل لتدقيق البيانات
    results = run_audit_checks(df)
    
    # تصدير التقرير المالي الاحترافي إلى Excel
